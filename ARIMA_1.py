...
#     data1_need_predict = np.diff(data1_price)
#     data2_need_predict = np.diff(data2_price)


#     # 
#     # model1_pre = ARIMA(data1_need_predict)
#     # pdq = model1_pre.fit()
#     # 27534.206555203138
#     # 23439.365828708724
#     model = ARIMA(data1_need_predict, order=(1, 0, 1))
#     model_fit = model.fit()
#     data1_predict = model_fit.predict(len(data1_need_predict), len(data1_need_predict)+pre_length-1)

#     model = ARIMA(data2_need_predict, order=(1, 0, 1))
#     model_fit = model.fit()
#     data2_predict = model_fit.predict(len(data2_need_predict), len(data2_need_predict)+pre_length-1)
    
#     data1_predict_price = np.cumsum(data1_predict) + data1_price[-1]
#     data2_predict_price = np.cumsum(data2_predict) + data2_price[-1]
